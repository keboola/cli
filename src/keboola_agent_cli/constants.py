...
# Per-stack form: KBC_MANAGE_TOKEN_<HOSTNAME_SUFFIX>, e.g. KBC_MANAGE_TOKEN_EU_CENTRAL_1
# for connection.eu-central-1.keboola.com. Suffix derived from the stack hostname
# at call time; see commands._helpers._stack_suffix_for_env_var().
ENV_KBC_MANAGE_TOKEN_PREFIX: str = "KBC_MANAGE_TOKEN_"
