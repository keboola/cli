...
SERVE_COMMAND_MAP: dict[tuple[str, str], str] = {
    ...
    ("GET", "/merge-requests/{project}"): "merge-request list",
    # serve-only: the branch->MR resolver the CLI hides behind an omitted --merge-request-id
    ("GET", "/merge-requests/{project}/by-branch/{branch_id}"): "",
    ("GET", "/merge-requests/{project}/{merge_request_id}"): "merge-request detail",
    ("GET", "/merge-requests/{project}/{merge_request_id}/conflicts"): "merge-request conflicts",
    (
        "GET",
        "/merge-requests/{project}/{merge_request_id}/diff/{component_id}/{config_id}",
    ): "merge-request diff",
    ...
    ("POST", "/merge-requests/{project}"): "merge-request create",
    ("POST", "/merge-requests/{project}/{merge_request_id}/approve"): "merge-request approve",
    ("POST", "/merge-requests/{project}/{merge_request_id}/merge"): "merge-request merge",
    (
        "POST",
        "/merge-requests/{project}/{merge_request_id}/request-changes",
    ): "merge-request request-changes",
    (
        "POST",
        "/merge-requests/{project}/{merge_request_id}/request-review",
    ): "merge-request request-review",
    (
        "POST",
        "/merge-requests/{project}/{merge_request_id}/resolve/{component_id}/{config_id}",
