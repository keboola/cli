...
CHANGELOG: dict[str, list[str]] = {
    "0.87.0": [
        ...
        "while unable to read a single row; the only diagnostic was `Missing env vars: "
        "WORKSPACE_ID (or KBC_WORKSPACE_MANIFEST_PATH)` buried in the container log, and an "
        "app that did not catch it crash-looped behind the probe instead. Default-ON because "
