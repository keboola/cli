...
CHANGELOG: dict[str, list[str]] = {
    "0.81.0": [
        ...
        "non-interactive (safe to script); omitting both starts an interactive picker (numbers, "
        "ranges, `all`, `none`, per-project alias prompt, final confirm) that needs a real "
