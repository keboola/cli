...
Status: **implemented in 0.78.0**
This plan has been implemented in full (see `kbagent auth login|status|logout`,
`src/keboola_agent_cli/auth/`, and the "0.78.0" entry in
...
**Addendum: the picker shipped (still 0.78.0, unreleased).** PR #535 landed with only
...
**Addendum 2: the picker's typed prompt was replaced with a checkbox (still 0.78.0,
