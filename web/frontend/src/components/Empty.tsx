      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {paths.map((p, i) => (
          ...
          >
            ...
            <h3 className="font-bold text-zinc-900 dark:text-zinc-100 text-base">{p.title}</h3>
...
export function Empty({
  ...
  return (
    <div className="nerd-card text-center py-10">
      <div className="text-zinc-700 text-sm dark:text-zinc-300">{title}</div>
...
export function ErrorBox({ message }: { message: string }) {
  return (
    <div className="nerd-card border-red-300 text-red-700 text-sm dark:border-red-700/40 dark:text-red-400">
