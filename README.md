...
**Browser login** — you have no token and a browser on this machine (since 0.81.0):
```bash
...
kbagent auth        login | status | register-projects | logout   # browser login, needs a human (0.81.0)
