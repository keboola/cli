...
6. **VERSION GATE**. On first invocation in a session, run
   ...
   **0.78.0+** -- below that, refuse and point at a static Storage token
...
**Programmatic auth (browser login)** (0.78.0+) -- full prose in
...
- **Aliases derive from the project NAME, never the numeric id** --
  ...
  `auth register-projects` (0.78.0+, see matrix above) to find/register the
